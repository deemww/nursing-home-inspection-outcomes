...
# =============================
# Layout: fixed left “controls panel” (not collapsible)
# =============================
controls, main = st.columns([1.15, 2.85], gap="large")
...
with controls:
    ...
    # Keep same “position” across regimes
