...
# =============================
# Pred map (defined early so _handle_chart_click can use it)
# =============================
pred_options = [
...
def _handle_chart_click(event):
    """If a bar was clicked, decode scenario_key and sync sidebar state."""
    try:
    ...
    st.session_state["pred_choice"] = reverse_pred[pred_num]
