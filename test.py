...
st.markdown(
    ...
    /* Remove default Streamlit top padding so header sits flush */
    ...
    /* ---- Sidebar section labels (h2/h3 → small uppercase BFI style) ---- */
    ...
    /* ---- Widget labels (radio + slider) → same small uppercase style ---- */
    ...
    /* ---- Radio items: selected — maroon text on warm tint bg ---- */
    ...
    /* ============================================================
       INSPECTION FREQUENCY SLIDER — clean maroon on white
       ============================================================ */
    ...
    /* Hide thumb value bubble and tick labels */
...
# =============================
with st.sidebar:
    # ── BFI-style "Policy Controls" header block ──
    st.markdown(
        """
        <div style="
    ...
    # ── Spacer before frequency section ──
    st.markdown("<div style='margin-top: 20px;'></div>", unsafe_allow_html=True)

    # ── Frequency labels above slider ──
